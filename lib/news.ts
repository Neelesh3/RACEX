...
export const news: News[] = [
  {
    id: "1",
    slug: "dramatic-finish-under-the-lights",
    title: "Dramatic Finish Under the Lights Delivers Season's Closest Grand Prix",
    excerpt:
    ...
    readTime: "5 min",
    featured: true,
    tags: ["Race", "Grand Prix", "Strategy"],
  },
  {
    id: "2",
    slug: "championship-leader-extends-advantage",
    title: "Championship Leader Extends Advantage with Consistent Performance",
    excerpt:
    ...
    readTime: "4 min",
    featured: false,
    tags: ["Driver", "Championship", "Podium"],
  },
  {
    id: "3",
    slug: "major-upgrade-package-shows-promise",
    title: "Major Aerodynamic Upgrade Shows Immediate Promise",
    excerpt:
    ...
    readTime: "6 min",
    featured: false,
    tags: ["Technical", "Aerodynamics", "Development"],
  },
  {
    id: "4",
    slug: "young-driver-impresses-in-first-full-season",
    title: "Young Rookie Continues to Impress During Breakthrough Season",
    excerpt:
    ...
    readTime: "4 min",
    featured: false,
    tags: ["Driver", "Rookie", "Performance"],
  },
  {
    id: "5",
    slug: "historic-circuit-remains-fan-favorite",
    title: "Historic Circuit Continues to Deliver Classic Formula One Racing",
    excerpt:
  ...
  },
  {
    ...
    readTime: "5 min",
    featured: false,
    tags: ["Team", "Podium", "Championship"],
  },
  {
    id: "7",
    slug: "technical-directive-sparks-discussion",
    title: "Technical Directive Becomes Major Talking Point Across the Paddock",
    excerpt:
    ...
    readTime: "6 min",
    featured: false,
    tags: ["Technical", "Regulations", "Engineering"],
  },
  {
    id: "8",
    slug: "driver-market-heats-up",
    title: "Driver Market Heats Up Ahead of Next Season",
    excerpt:
    ...
    readTime: "5 min",
    featured: false,
    tags: ["Transfer", "Contracts", "Drivers"],
  },
  {
    id: "9",
    slug: "pit-stop-record-nearly-broken",
    title: "Pit Crew Delivers Lightning-Fast Stop During Grand Prix",
    excerpt:
    ...
    readTime: "3 min",
    featured: false,
    tags: ["Pit Stop", "Team", "Strategy"],
  },
  {
    id: "10",
    slug: "street-circuit-weekend-preview",
    title: "Teams Prepare for Challenging Street Circuit Weekend",
    excerpt:
  ...
  },
  {
    ...
    readTime: "7 min",
    featured: false,
    tags: ["History", "Classic Races", "Formula One"],
  },
  {
    id: "12",
    slug: "wind-tunnel-development-focus",
    title: "Development Focus Shifts Toward Next Generation Aerodynamics",
    excerpt:
    ...
    readTime: "6 min",
    featured: false,
    tags: ["Technical", "Wind Tunnel", "Development"],
  },
  {
    id: "13",
    slug: "constructor-title-battle-intensifies",
    title: "Constructor Championship Battle Intensifies After Double Podium",
    excerpt:
    ...
    readTime: "5 min",
    featured: false,
    tags: ["Constructors", "Championship", "Team"],
  },
  {
    id: "14",
    slug: "experienced-driver-reaches-milestone",
    title: "Veteran Driver Celebrates Major Formula One Milestone",
    excerpt:
    ...
    readTime: "4 min",
    featured: false,
    tags: ["Driver", "Milestone", "Career"],
  },
  {
    id: "15",
    slug: "future-stars-making-an-impact",
    title: "Formula One's Next Generation Continues to Impress",
    excerpt:
    ...
    readTime: "5 min",
    featured: false,
    tags: ["Drivers", "Future", "Rookies"],
  },
];

export const featuredNews: News =
  news.find((article) => article.featured) ?? news[0];

export const latestNews: News[] = [...news]
  .sort(
    (a, b) =>
