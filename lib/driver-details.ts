// lib/driver-details.ts
import type {
  DriverDetails,
  DriverSocial,
  DriverTimelineItem,
  DriverAchievement,
} from "@/types/driver-details";

function createSocials(instagram: string): DriverSocial[] {
  return [
    {
      platform: "Instagram",
      handle: instagram,
...
function createTimeline(
  debut: number,
  highlights: DriverTimelineItem[]
): DriverTimelineItem[] {
  return [
    {
      year: debut,
      achievement: "Formula One Debut",
      description: "Made Formula One debut.",
    },
    ...highlights,
  ];
}
...
function createAchievements(
  ...
  if (championships > 0) {
    achievements.push({
      id: "championship",
      year: 2021,
      title: `${championships}× World Champion`,
      description: "Formula One Drivers' Champion",
      type: "championship",
    });
  }
  ...
  if (wins > 0) {
    achievements.push({
      id: "wins",
      year: 2025,
      title: `${wins} Grand Prix Wins`,
      description: "Career Formula One victories.",
      type: "win",
    });
  }
...
export const driverDetails: Record<string, DriverDetails> = {
  ...
  "lando-norris": {
    ...
    achievements: createAchievements(8, 0),
    statistics: {
      races: 140,
      points: 1150,
      podiumRate: "25.0%",
  ...
  "oscar-piastri": {
    ...
    timeline: createTimeline(2023, [
      {
        year: 2019,
        achievement: "Formula Renault Eurocup Champion",
        description:
          "Captured the Formula Renault Eurocup achievement after an outstanding season.",
      },
      {
        year: 2020,
        achievement: "Formula 3 Champion",
        description:
          "Won the FIA Formula 3 Championship during his rookie campaign.",
      },
      {
        year: 2021,
        achievement: "Formula 2 Champion",
        description:
          "Claimed the FIA Formula 2 Championship in dominant fashion.",
      },
      {
        year: 2023,
        achievement: "Sprint Race Winner",
        description:
      ...
      {
        year: 2025,
        achievement: "Championship Challenger",
        description:
  ...
  "lewis-hamilton": {
    ...
    timeline: createTimeline(2007, [
      ...
      {
        year: 2013,
        achievement: "Joined Mercedes",
        description:
          "Moved to Mercedes, beginning one of the most successful partnerships in Formula One history.",
      },
      {
        year: 2014,
        achievement: "Second World Championship",
        description:
          "Led Mercedes to the beginning of the hybrid-era dominance.",
      },
      {
        year: 2020,
        achievement: "Seven-Time World Champion",
        description:
          "Equalled the all-time Drivers' Championship record with his seventh world achievement.",
      },
      {
        year: 2025,
        achievement: "Ferrari Move",
        description:
          "Started a new chapter of his Formula One career by joining Ferrari.",
      },
    ]),
    achievements: createAchievements(105, 7),
    statistics: {
      races: 370,
      points: 4950,
      podiumRate: "54.6%",
  ...
  "george-russell": {
    ...
    timeline: createTimeline(2019, [
      ...
      {
        year: 2023,
        achievement: "Mercedes Team Leader",
        description:
    ...
    achievements: createAchievements(3, 0),
    statistics: {
      races: 135,
      points: 920,
      podiumRate: "13.3%",
  ...
  "fernando-alonso": {
    ...
    careerSummary:
      "Making his Formula One debut in 2001, Alonso became the youngest double World Champion after consecutive achievements with Renault. Throughout an extraordinary career spanning more than two decades, he has driven for several iconic teams while remaining one of the fastest and most complete drivers on the grid.",
  ...
  "gabriel-bortoleto": {
    ...
    timeline: createTimeline(2025, [
      ...
      },
      {
        ...
        achievement: "Formula 2 Champion",
        description:
          "Captured the FIA Formula 2 achievement and secured promotion to Formula One.",
      },
    ]),
    achievements: createAchievements(0, 0),
    statistics: {
  ...
  "yuki-tsunoda": {
    ...
    timeline: createTimeline(2021, [
      ...
      {
        year: 2025,
        achievement: "Consistent Points Scorer",
        description:
  ...
  "lance-stroll": {
    ...
    timeline: createTimeline(2017, [
      {
        year: 2016,
        achievement: "European Formula 3 Champion",
        description:
  ...
  "franco-colapinto": {
    ...
    timeline: createTimeline(2024, [
      {
        year: 2021,
        achievement: "Formula Regional Success",
        description:
