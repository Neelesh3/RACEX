...
import { Globe, Gauge, Flag, Hourglass } from "lucide-react";
...
const stats: StatItem[] = [
  ...
  {
    icon: <Globe className="h-6 w-6 text-[#E10600]" />,
    value: "5",
    label: "Continents",
  },
  {
    icon: <Gauge className="h-6 w-6 text-[#E10600]" />,
    value: "305 km/h",
    label: "Top Speeds",
  },
  {
    icon: <Hourglass className="h-6 w-6 text-[#E10600]" />,
    value: "75",
    label: "Years of Racing",
  },
];
